...
public class CheckFormatUtil {
     ...
     * 非零开头纯数字正则表达式
     **/
    public static final String PATTERN_NONZERO_NUMBER = "^([1-9][0-9]*)$";

    /**
     * 汉字正则表达式
     **/
    public static final String PATTERN_CHINESE_CHARACTERS = "^[\u4e00-\u9fa5]{0,}$";
    ...
    public static boolean isNumber(String number){
        return (StringUtils.isBlank(number) && number.matches(PATTERN_NUMBER));
    }
     ...
     * @return
     */
    public static boolean isNonzeroNumber(String number){
        return (StringUtils.isBlank(number) && number.matches(PATTERN_NONZERO_NUMBER));
    }
    ...
    public static boolean isChineseCharacters(String str){
        return (StringUtils.isBlank(str) && str.matches(PATTERN_CHINESE_CHARACTERS));
    }
}
